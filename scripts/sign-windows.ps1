...
#   powershell -ExecutionPolicy Bypass -File scripts\sign-windows.ps1 `
#     -Verify -Identity "https://github.com/stophemo/T101/.github/workflows/build-sign.yml@refs/heads/main"
#
...
if ($Verify) {
  if (-not $Identity) {
    throw "校验需要 -Identity，例如 -Identity 'https://github.com/stophemo/T101/.github/workflows/build-sign.yml@refs/heads/main'"
  }
  & $cosign verify-blob `
    --certificate "$Exe.pem" `
    --signature "$Exe.sig" `
